      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-start space-y-8">
            {/* Badge */}
            <div 
              className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 text-white px-6 py-3 rounded-full"
              data-aos="fade-up"
              data-aos-delay="100"
            >
            ...
            <div className="space-y-4">
              ...
              {/* Rotating Words */}
              <div 
                className="flex items-center gap-3 text-2xl md:text-3xl text-white/80"
                data-aos="fade-up"
                data-aos-delay="300"
              >
                ...
                <div className="h-10 overflow-hidden">
                  ...
                  >
                    {words.map((word) => (
                      <div 
                        key={word} 
                        className="h-10 font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent"
                      >
                        {word}
                      </div>
                    ))}
            ...
            >
              <Button 
                asChild 
                size="lg" 
                className="group gap-3 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-bold text-lg px-8 py-6 rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 border-0"
              >
                <Link to="/collection">
                  Shop Collection
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="group border-2 border-white/30 bg-white/10 backdrop-blur-sm text-white hover:bg-white hover:text-gray-900 font-semibold text-lg px-8 py-6 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl"
              >
